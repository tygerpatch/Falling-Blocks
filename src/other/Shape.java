...
public class Shape {
   ...
   // Use protected access modifer for squares to allow subclasses to define
   // custom relative positioning for squares.
   ...
   // row, column arguments represent center of shape, that way Shape can be placed anywhere on board
   ...
   public Square[] getSquares() {
      ...
      for (int i = 0; i < squares.length; i++) {
         ...
         squares[i].setPosition(position.getRow() + center.getRow(),
